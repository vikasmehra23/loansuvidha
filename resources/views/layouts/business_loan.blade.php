                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="row my-3">
                            <div class="col-lg-3 col-md-3 col-6">
                                <div class="businessbq_main text-center">
                                    <div class="businessbq_img">
                                        <img src="assets/img/online-Disbursement.png" alt="" class="img-fluid">
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-6">
                                <div class="businessbq_main text-center">
                                    <div class="businessbq_img">
                                        <img src="assets/img/interest-rate.png" alt="" class="img-fluid">
                                    </div>
                                    <div class="businessbq">
                            ...
                            <div class="col-lg-3 col-md-3 col-6">
                                <div class="businessbq_main text-center">
                                    <div class="businessbq_img">
                                        <img src="assets/img/loan-duration-icon.png" alt="" class="img-fluid">
                                    </div>
                                    <div class="businessbq">
                            ...
                            <div class="col-lg-3 col-md-3 col-6">
                                <div class="businessbq_main text-center">
                                    <div class="businessbq_img">
                                        <img src="assets/img/collateral.png" alt="" class="img-fluid">
                                    </div>
                                    <div class="businessbq">
            ...
            <div class="col-lg-12 col-md-12 col-12">
                <div class="row justify-content-center text-center ">
                    <div class="col-lg-2 col-md-6 col-12">
                        <div class="doyou_heading mb-4">
                            <div class="doyou_img">
                                ...
                                <img src="assets/img/why-invest-icon1.png" alt="" class="img-fluid ">
                            </div>
                            <div class="doyou_txt">
                    ...
                    <div class="col-lg-2 col-md-6 col-12">
                        <div class="doyou_heading mb-3">
                            <div class="doyou_img final_m">
                                <img src="assets/img/finacil_support.png" alt="" class="img-fluid">
                            </div>
                            <div class="doyou_txt">
                    ...
                    <div class="col-lg-2 col-md-6 col-12">
                        <div class="doyou_heading mb-3">
                            <div class="doyou_img final_m">
                                <img src="assets/img/office_reno-re.png" alt="" class="img-fluid ">
                            </div>
                            <div class="doyou_txt">
                    ...
                    <div class="col-lg-2 col-md-6 col-12">
                        <div class="doyou_heading mb-3">
                            <div class="doyou_img final_m">
                                <img src="assets/img/grgrgr.png" alt="" class="img-fluid ">
                            </div>
                            <div class="doyou_txt">
                    ...
                    <div class="col-lg-2 col-md-6 col-12">
                        <div class="doyou_heading mb-3">
                            <div class="doyou_img">
                                <img src="assets/img/workplace.png" alt="" class="img-fluid ">
                            </div>
                            <div class="doyou_txt">
                ...
                <div class="owl-carousels owl-theme" id="main_slide">
                    <div class="item">
                        <div class="carousel_img_main">
                            <img src="assets/img/businesss_loan (1).jpg" alt="" class="img-fluid ">
                        </div>
                    </div>

                    <div class="item">
                        <div class="carousel_img_main">
                            <img src="assets/img/medium_business_loan (2).jpg" alt="" class="img-fluid ">
                        </div>
                    </div>
                    <div class="item">
                        <div class="carousel_img_main">
                            <img src="assets/img/Business-Loan-for-Manufacturers (1).jpg" alt="" class="img-fluid ">
                        </div>
                    </div>
                    <div class="item">
                        <div class="carousel_img_main">
                            <img src="assets/img/business_loan_industries.jpg" alt="" class="img-fluid ">
                        </div>
                    </div>
                    <div class="item">
                        <div class="carousel_img_main">
                            <img src="assets/img/business loan for Propietor 11.jpg" alt="" class="img-fluid ">
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-12 py-2">
                <div class="main_Session">
                    <div class="img_Session">
                        <img src="assets/img/draw_1.svg" alt="" class="img-fluid ">
                    </div>
            ...
            <div class="col-lg-4 col-md-4 col-12 py-2">
                <div class="main_Session">
                    <div class="img_Session">
                        <img src="assets/img/draw_2.svg" alt="" class="img-fluid ">
                    </div>
                    <div class="main_cntnt_g">
            ...
            <div class="col-lg-4 col-md-4 col-12 py-2">
                <div class="main_Session">
                    <div class="img_Session">
                        <img src="assets/img/draw_3.svg" alt="" class="img-fluid ">
                    </div>
                    <div class="main_cntnt_g">
        ...
        <div class="slick-slider mt-5">
                ...
                <div class="cntnrt_slicky">
                    ...
                    <div class="mainlx_sl">
                        <div class="main_under_slicky">
                            <img src="assets/img/mr_vinay_.png" alt="">
            ...
            <div class="slick_home_testimonial">
                <div class="cntnrt_slicky">
                    ...
                    <div class="mainlx_sl">
                        <div class="main_under_slicky">
                            <img src="assets/img/ajay_bhati_.png" alt="">
                            <div class="neetu_texture">
                                <h5 class="card-title fw-bold">Ajay Bhati</h5>
                                <div class="star_flex">
                                    <i class="fa-solid fa-star"></i>
            ...
            <div class="slick_home_testimonial">
                <div class="cntnrt_slicky">
                    ...
                    <div class="mainlx_sl">
                        <div class="main_under_slicky">
                            <img src="assets/img/shiv_uuuu.png" alt="">
                            <div class="neetu_texture">
                                <h5 class="card-title fw-bold">shiva Thakur </h5>
                                <div class="star_flex">
                                    <i class="fa-solid fa-star"></i>
