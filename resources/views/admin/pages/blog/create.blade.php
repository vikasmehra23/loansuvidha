    ...
    <div class="col-lg-8 mx-auto mt-5">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 h6">Blog Create</h5>
            ...
            <div class="card-body">
                <form id="add_form" class="form-horizontal" action="{{ route('blog.store') }}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="Blog Title" id="title" name="title" class="form-control" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                           <textarea class="form-control" rows="5" id="blog_description" name="description"></textarea> 
